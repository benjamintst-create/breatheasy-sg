...
const GREEN_ZONES: { name: string; ring: [number, number][] }[] = [
  ...
  { name: "Gardens by the Bay", ring: [
    [103.861, 1.278], [103.870, 1.278], [103.870, 1.284], [103.861, 1.284],
  ]},
  // Marina Bay / Bayfront promenade
  { name: "Marina Bay Promenade", ring: [
    [103.852, 1.284], [103.861, 1.284], [103.861, 1.290], [103.852, 1.290],
  ]},
  // Singapore Botanic Gardens
  { name: "Botanic Gardens", ring: [
    [103.813, 1.310], [103.820, 1.310], [103.820, 1.322], [103.813, 1.322],
  ]},
  // MacRitchie Reservoir Park
  { name: "MacRitchie Reservoir", ring: [
    [103.820, 1.335], [103.840, 1.335], [103.840, 1.348], [103.835, 1.355],
    [103.825, 1.355], [103.820, 1.348],
  ]},
  // Bedok Reservoir Park
  { name: "Bedok Reservoir Park", ring: [
    [103.930, 1.336], [103.940, 1.336], [103.940, 1.342], [103.930, 1.342],
  ]},
  // Pandan Reservoir Park
  { name: "Pandan Reservoir Park", ring: [
    [103.735, 1.305], [103.748, 1.305], [103.748, 1.315], [103.735, 1.315],
  ]},
  // Jurong Lake Gardens (Lakeside Garden + Chinese/Japanese Gardens + lake perimeter)
  { name: "Jurong Lake Gardens", ring: [
    [103.718, 1.325], [103.745, 1.325], [103.745, 1.340], [103.740, 1.348],
    [103.722, 1.348], [103.718, 1.340],
  ]},
  // West Coast Park
  { name: "West Coast Park", ring: [
    [103.758, 1.280], [103.770, 1.280], [103.770, 1.287], [103.758, 1.287],
  ]},
  // Pasir Ris Park
  { name: "Pasir Ris Park", ring: [
    [103.942, 1.373], [103.960, 1.373], [103.960, 1.382], [103.942, 1.382],
  ]},
  // Bishan-Ang Mo Kio Park
  { name: "Bishan-AMK Park", ring: [
    [103.843, 1.356], [103.852, 1.356], [103.852, 1.365], [103.843, 1.365],
  ]},
  // Fort Canning Park
  { name: "Fort Canning Park", ring: [
    [103.843, 1.293], [103.849, 1.293], [103.849, 1.298], [103.843, 1.298],
  ]},
  // Labrador Nature Reserve
  { name: "Labrador Nature Reserve", ring: [
    [103.800, 1.264], [103.808, 1.264], [103.808, 1.270], [103.800, 1.270],
  ]},
  // Kent Ridge Park
  { name: "Kent Ridge Park", ring: [
    [103.787, 1.282], [103.796, 1.282], [103.796, 1.290], [103.787, 1.290],
  ]},
  // Lower + Upper Seletar Reservoir
  { name: "Seletar Reservoir", ring: [
    [103.815, 1.393], [103.830, 1.393], [103.830, 1.402], [103.815, 1.402],
  ]},
  // Punggol Waterway Park
  { name: "Punggol Waterway Park", ring: [
    [103.898, 1.404], [103.914, 1.404], [103.914, 1.412], [103.898, 1.412],
  ]},
  // Coney Island / Punggol Point
  { name: "Coney Island", ring: [
    [103.915, 1.411], [103.930, 1.411], [103.930, 1.418], [103.915, 1.418],
  ]},
  // Tampines Eco Green
  { name: "Tampines Eco Green", ring: [
    [103.952, 1.355], [103.960, 1.355], [103.960, 1.362], [103.952, 1.362],
  ]},
  // Southern Ridges (from Kent Ridge to Mount Faber)
  { name: "Southern Ridges", ring: [
    [103.800, 1.270], [103.818, 1.275], [103.818, 1.280], [103.800, 1.275],
  ]},
  // Bukit Timah Nature Reserve
  { name: "Bukit Timah Nature Reserve", ring: [
    [103.772, 1.348], [103.782, 1.348], [103.782, 1.358], [103.772, 1.358],
  ]},
];
